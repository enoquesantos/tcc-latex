...
Item {
	Component.onCompleted: {
		var fooList = []
		fooList = App.readSetting("foo",SettingTypeStringList)
		if (fooList.length)
			fooList[0] = "bar"
		App.saveSetting("foo",fooList)
	}
}
\end{lstlisting}
