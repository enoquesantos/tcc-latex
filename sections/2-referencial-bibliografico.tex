...
\section{ARQUITETURAS E TECNOLOGIAS \\PARA SISTEMAS MOBILE}
...
\subsection{Arquitetura de Software} %2.2
...
\subsection{Arquitetura de Referência} %2.3
...
\subsection{Sistemas de Informação} %2.4
...
\subsection{Arquiteturas de Aplicativos Móveis} %2.5
...
\subsection{Projeto de Aplicativos Móveis} %2.6
...
\subsection{Desenvolvimento Orientado a Componentes} %2.7
...
\subsection{Web Services, RESTful, Push Notification e JSON} %2.8
